...
class BankingChatbotStub(object):
...
class BankingChatbotServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_BankingChatbotServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'BankingChatbot', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('BankingChatbot', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class BankingChatbot(object):
    """Missing associated documentation comment in .proto file."""
